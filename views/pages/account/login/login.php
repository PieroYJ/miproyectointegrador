                ...
                if($item->status == 200){
                   ...
                   Actualizar el campo de verificación
                    ...
                    if($verificationUser->status == 200){
                        ...
                        echo '<div class="alert alert-success text-center">Su cuenta a sido verificada, ya puede autenticarse</div>';
                    }
                }

            }else{

                echo '<div class="alert alert-danger text-center">Fallo en la verificación, el email no existe</div>';
