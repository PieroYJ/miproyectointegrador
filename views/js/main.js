...
function validateImageJS(event, input){
    ...
    if(image["type"] !== "image/jpeg" && image["type"] !== "image/png"){
        ...
        fncSweetAlert("error", "La imagen debe ser JPG o PNG", null)
    ...
    =============================================*/
        ...
        fncSweetAlert("error", "La imagen no puede acceder los 2mb", null)
    ...
    if(validation.length > 0){      
       ...
       /*=============================================
        ...
        if(methodPaid == "mercado-pago"){
            ...
            var settings = {
              "url": "https://free.currconv.com/api/v7/convert?q=USD_COP&compact=ultra&apiKey=[YOUR API KEY]",
              "method": "GET",
              "timeout": 0
            };
