...
class TemplateController{
	...
	static public function path(){
		...
		if(!empty($_SERVER['HTTPS']) && ('on' == $_SERVER['HTTPS'])){
			...
			return "https://localhost/miproyectointegrador/"; // Pruebas Facebook	

		}else{

			return "http://miproyectointegrador.com/";
		}
	...
	static public function sendEmail($name, $subject, $email, $message, $url){
		...
		$mail->setFrom("soporte@proyectointegrador.com", "Equipo de soporte");
