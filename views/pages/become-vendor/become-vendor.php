...
<div class="container-fluid p-0">
    ...
    <div class="ps-vendor-banner bg--cover" style="background: url(img/vendor/vendor.jpg);">
        <div class="container">
            <h2>Millones De Compradores no puedo Esperar A Ver Lo Que Tienen En la Tienda</h2><a class="ps-btn ps-btn--lg" href="/s">Empezar a vender</a>
        </div>
    </div>
    ...
    <div class="ps-vendor-banner bg--cover" style="background: url(img/vendor/vendor.jpg);">
        <div class="container">
            <h2>Millions Of Shoppers Can’t Wait To See What You Have In Store</h2><a class="ps-btn ps-btn--lg" href="s">Start Selling</a>
        </div>
    </div>
